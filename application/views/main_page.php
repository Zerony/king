            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-7 col-md-7 col-sm-7" data-appear-top-offset="-200" data-animated="fadeInLeft">
                        ...
                        <p>Сьогодні гра була дуже непердбачувана. Непередбачуваність полягає насамперед в тому, що дім
                            Баратеонів переміг! Перший раз за історію клубу! Вітаємо Дімона з цією заслуженою перемогою.
                            Стратегія і тактика гри Баратеона була доволі витриманою і продуманою. До 7 раунда лідером
                            був Егор, який грав за дім Грейджоїв, і в результаті третє місце на лаві переможців. Але
                            щось не вистачило в його грі, і позиція була здана на користь Баратеона.</p>

                        <p><a href="javascript:void(0);" onclick='$("#fulltext").show();$(this).hide();'>Читати
                                продовження</a></p>
    <span id="fulltext">
    <p>Друге заслужене місце в цій грі дісталось нашій блондинці клубу Ані) Вона боролась за перемогу дома Мартелів.
        Трішки наполегливості і брутальності ій не вистачило для перемоги. Але все ще попереду, і Аня ще не раз покаже,
        на що здатні красуні-блондинки!</p>
    <p>Третє місце зайняла не менш прекрасна дівчина нашого клубу - Анюта). Вона грала за дім Старків. Легкість та
        невимушеність тактичноі гри Анюти принесла ій заслужену бронзу в землях Вестероса. </p>
    <p>Також ця гра була особливою ще тим, що в нас був новий гравець, Вован, який з першого разу в грі зайняв місце в
        трійці лідерів до 5 раунду. Чіткість, продуманість і правильність ходів здивувала мене, як ведучу, оскільки маю
        право підмітити, що як для новачка Вова грав дуже достойно і правильно. Дім Ланістерів нещадно розгромив армію
        дома Тірелів, за який виступав Максим. Нажаль, але так трапляється, що гравець повністю покидає гру. Але в Макса
        є всі шанси відімститись за сьогоднішню поразку і показати, що він здатен перемогти.</p>
    <p>Гарна гра, багато емоцій і цікаві гравці!</p>
    </span>
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-5 ipad_img_in" data-appear-top-offset="-200"
                        ...
                        <img class="ipad_img1" src="/images/gerb/Martell.png" alt=""/>
                    </div>
                </div>
                <!-- //ROW -->
            </div>
